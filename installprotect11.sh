    ...
    <div class="col-xs-12">
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                Protected by:
                <span class="label label-primary">@luxzopicial</span>
                <span class="label label-success">@luxzchh</span>
                <span class="label label-info">Luxz Official</span>
            </p>
        </div>
        @else
...
sed -i "s|@luxzopiciall|${CONTACT_TELEGRAM}|g" "$INDEX_FILE" 2>/dev/null || true
