...
BRAND_NAME="${BRAND_NAME:-Luxz Official}"
BRAND_TEXT="${BRAND_TEXT:-Protect By Luxz}"
CONTACT_TELEGRAM="${CONTACT_TELEGRAM:-@luxzopicial}"
    ...
    <div class="col-xs-12">
                        ...
                        @foreach ($servers as $server)
                            <tr class="align-middle">
                                <td class="middle">
                                    ...
                                    @if($server->id == 26)
                                    <br><small class="text-muted">Jhoanley Official</small>
                                    @endif
                                </td>
                                ...
                                <td class="middle">
                                    ...
                                    @if($server->id == 26)
                                    <br><small><code>Jhoanley Official:2007</code></small>
                                    @endif
                                </td>
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                Protected by:
                <span class="label label-primary">Luxz Official</span>
                <span class="label label-success">@luxzopicial</span>
                <span class="label label-info">@luxzchh</span>
            </p>
        </div>
        @else
...
sed -i "s|Luxz Official|${BRAND_NAME}|g" "$INDEX_FILE" 2>/dev/null || true
sed -i "s|@luxzopicial|${CONTACT_TELEGRAM}|g" "$INDEX_FILE" 2>/dev/null || true
sed -i "s|@luxzopicial|${CONTACT_TELEGRAM}|g" "$INDEX_FILE" 2>/dev/null || true
sed -i "s|Protected by: Luxz Official|Protected by: ${BRAND_NAME}|g" "$INDEX_FILE" 2>/dev/null || true
...
echo "🛡️ Security by: @luxzopicial"
